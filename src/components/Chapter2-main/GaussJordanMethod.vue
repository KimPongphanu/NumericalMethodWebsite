        ...
        <div id="box-1">
            ...
            <div id="box-last">
                <div id="box-14">
                    ...
                    <button @click="calculateGaussJordan">Calculate</button>
                </div>
                <!-- Output Section -->
    ...
    methods: {
        ...
        calculateGaussJordan() {
            try {
                ...
                this.solutions = augmentedMatrix.map(row => row[n].toFixed(6));
            } catch (error) {
                console.error("Error calculating Gauss Jordan Method:", error);
