<template>
    <div class="container">
        ...
        <div id="box-1">
            ...
            <button @click="calculateIteration" id="btn2">Calculate</button>
        </div>
...
export default {
    ...
    methods: {
        ...
        calculateIteration() {
            ...
            let x1;
            const g = (x) => evaluate(this.functionInput, { x });
            this.iterations = [];
            ...
            } while (Math.abs(x1 - x0) >= this.tolerance);
